/**
 * NID'Z RESTAURANT — i18n (English / Arabic / Russian / Georgian)
...
const I18N = {
  ...
  ka: {
    dir: "ltr",
    label: "ქართული",
    nav: { home:"მთავარი", menu:"მენიუ", about:"ჩვენს შესახებ", gallery:"გალერეა", reviews:"მიმოხილვები", contact:"კონტაქტი", orderNow:"შეკვეთა" },
    footer: {
      tagline:"ცეცხლზე შემწვარი შაურმა, ქაბაბი და ნაყარი რულეტები, ახალი მომზადებული ბათუმში — ნამდვილი ინგრედიენტები, ნამდვილი გემო.",
      taglineShort:"ცეცხლზე შემწვარი შაურმა, ქაბაბი და ნაყარი რულეტები, ახალი მომზადებული ბათუმში.",
      quickLinks:"სწრაფი ბმულები", getInTouch:"დაგვიკავშირდით", findUs:"სად ვართ",
      rights:"ყველა უფლება დაცულია.", privacy:"კონფიდენციალურობის პოლიტიკა", terms:"მომსახურების პირობები"
    },
    common: {
      whatsappUs:"WhatsApp-ზე დაწერა", callNow:"დარეკვა", getDirections:"მისამართის ნახვა",
      viewMenu:"მენიუს ნახვა", orderOnline:"ონლაინ შეკვეთა", home:"მთავარი"
    },
    home: {
      heroTitle1:"ცოცხალი ცეცხლი.", heroTitle2:"ნამდვილი გემო.",
      heroLede:"ცეცხლზე შემწვარი შაურმა, ქაბაბი და ნაყარი რულეტები, ახალი მომზადებული შეკვეთით ბათუმის გულში.",
      orderNow:"🔥 შეკვეთა", viewMenu:"მენიუ", scroll:"გადაფურცვლა",
      tickerFresh:"ახალი შემწვარი ყოველდღე", tickerSpecial:"Nid'Z-ის განსაკუთრებული შაურმა", tickerBeast:"Beast შაურმა",
      tickerReal:"ნამდვილი ინგრედიენტები, ნამდვილი გემო", tickerMade:"ახალი მომზადებული", tickerFlame:"ბათუმის ცეცხლი",
      featuredEyebrow:"ცეცხლზე", featuredTitle:"განსაკუთრებული კერძები",
      featuredDesc:"გემო, რაც ცეცხლზე იწვება ყოველდღე — ფენა-ფენა, არასდროს აჩქარებით.",
      seeFullMenu:"სრული მენიუ",
      whyEyebrow:"რატომ Nid'Z", whyTitle:"აგებულია ცეცხლზე, არა მოკლე გზებზე",
      f1Title:"მზადდება შეკვეთის მიხედვით", f1Desc:"თითოეული შამფური და კატლეტი ცეცხლზე ხვდება მხოლოდ თქვენი შეკვეთის შემდეგ — არა გახურება, არა მოკლე გზები.",
      f2Title:"ახალი ინგრედიენტები", f2Desc:"ბოსტნეული იჭრება ყოველდღე, სოუსები მზადდება ადგილზე, პური ცხვება თბილი — არაფერი ჩერდება.",
      f3Title:"სწრაფი, მეგობრული მომსახურება", f3Desc:"სწრაფი, მაგრამ აჩქარების გარეშე — შეკვეთა, შეფუთვა, გაცხელებული კარიდან გასვლა.",
      f4Title:"ოჯახისთვის განკუთვნილი", f4Desc:"დასასვენებელი ადგილი ბათუმში, სწრაფი საჭმლის ან მთელი ოჯახისთვის სრული სუფრისთვის.",
      galleryEyebrow:"შეფუთვის მიღმა", galleryTitle:"სამზარეულოს შიგნიდან", viewFullGallery:"სრული გალერეა",
      testiEyebrow:"სტუმრები ამბობენ", testiTitle:"პირდაპირ სუფრიდან",
      t1q:"\"Beast შაურმა თავის სახელს ამართლებს — უზარმაზარი, ცხელი და გემოთი სავსე. საუკეთესო რულეტი, რაც ბათუმში მიჭამია.\"", t1n:"ნინა კ.", t1r:"ადგილობრივი გიდი",
      t2q:"\"სწრაფი, მეგობრული და ნივრის სოუსი დამოკიდებულია. მოგზაურობის დროს სამჯერ დავბრუნდით.\"", t2n:"ლევან თ.", t2r:"რეგულარული სტუმარი",
      t3q:"\"ოჯახისთვის განკუთვნილი, დიდი პორციები და ყველაფერი ნამდვილად ახალია. Phoenix აუცილებლად უნდა სცადოთ.\"", t3n:"სოფია მ.", t3r:"ტურისტის მიმოხილვა",
      testiNote:"ნაჩვენებია სტუმრების ციტატები მაგალითისთვის — ნებისმიერ დროს შეცვალეთ თქვენი რეალური მიმოხილვებით.",
      reviewSub:"შეფასებული ჩვენი სტუმრების მიერ", reviewGoogle:"ნახეთ ჩვენი Google მიმოხილვები", reviewTrip:"წაიკითხეთ TripAdvisor-ზე", reviewAll:"ყველა მიმოხილვა",
      followEyebrow:"მიჰყევით ცეცხლს", followTitle:"@nidzrestaurant",
      socialInstagram:"Instagram", socialTiktok:"TikTok", socialTrip:"TripAdvisor", socialMaps:"Google Maps",
      ctaTitle:"მოშივდით?", ctaDesc:"შეუკვეთეთ ონლაინ გატანით ან მიტანით, ან მოდით და ჩვენ გავაცხელებთ გრილს თქვენთვის.",
      ctaOrder:"ონლაინ შეკვეთა"
    },
    about: {
      eyebrow:"ჩვენი ისტორია", title:"ხელით დამზადებული, სიყვარულით შემწვარი", crumb:"ჩვენს შესახებ",
      whoEyebrow:"ვინ ვართ", storyTitle:"ქუჩის საჭმელი, ამაღლებული",
      story1:"Nid'Z დაიწყო მარტივი იდეით: შაურმა და ცეცხლზე შემწვარი რულეტები იმსახურებენ იმავე ზრუნვას, რასაც სრული კვება. ყოველი შეკვეთა მზადდება შეკვეთის მიხედვით — ხორცი იწვება თქვენი მოთხოვნის შემდეგ, ბოსტნეული იჭრება იმ დღეს, სოუსები მზადდება ადგილზე — რადგან რულეტი იმდენად კარგია, რამდენადაც კარგია მისი შიგთავსი.",
      story2:"დღეს Nid'Z არის ბათუმის ფავორიტი ადგილობრივებისა და მოგზაურებისთვის, ცნობილი დიდი პორციებით, მდიდარი ფენოვანი გემოთი და მენიუთი, რომელიც მოიცავს კლასიკური ქაბაბიდან ჩვენს ფირმულ კომბინაციებამდე, როგორიცაა Beast შაურმა და Phoenix.",
      story3:"მიუხედავად იმისა, იღებთ სწრაფ რულეტს სანაპიროსა და ბულვარს შორის, თუ ოჯახთან ერთად ზიხართ სრული კვებისთვის, Nid'Z შექმნილია იმისთვის, რომ სწორად გაგაჭმოთ.",
      badge:"ნამდვილი ინგრედიენტები",
      missionEyebrow:"ჩვენი მისია", missionTitle:"ახალი, სწრაფი, არასდროს ყალბი",
      missionDesc:"ჩვენ არსებობს იმის დასამტკიცებლად, რომ სწრაფი საჭმელი მაინც შეიძლება იყოს პატიოსანი საჭმელი. ეს ნიშნავს — არა მზა მოკლე გზებს, არა გამათბობელი ნათურის ქვეშ დგომას და არა კომპრომისს ინგრედიენტებზე, რომლებიც რულეტს ბოლო ნაკბენამდე ღირებულს ხდის.",
      v1t:"ახალი ინგრედიენტები, ყოველდღე", v1d:"პროდუქტები მზადდება ახალი ყოველ დილით — არაფერი იჭრება წინასწარ და ინახება დღეების განმავლობაში.",
      v2t:"ხარისხიანი მომსახურება", v2d:"სწრაფი არ ნიშნავს აჩქარებულს — ყოველი შეკვეთა იღებს იმავე ყურადღებას, იქნება ეს დარბაზში თუ გატანით.",
      v3t:"ოჯახური ატმოსფერო", v3d:"დასასვენებელი, მისასალმებელი სივრცე ბათუმში, სადაც ყოველი სტუმარი — დიდი თუ პატარა — თავს სახლში გრძნობს.",
      ctaTitle:"მოდი და გაიგე განსხვავება", ctaDesc:"მობრძანდით, შეუკვეთეთ ონლაინ გატანით ან მიტანით — გრილი მზად იქნება.",
      ctaMenu:"მენიუს ნახვა", ctaFind:"სად ვართ"
    },
    menu: {
      eyebrow:"ახალი გრილიდან", title:"ჩვენი მენიუ", crumb:"მენიუ",
      orderOnline:"ონლაინ შეკვეთა",
      embedEyebrow:"სრული ინტერაქტიული მენიუ", embedTitle:"ყველა პოზიცია და ფასი",
      embedDesc:"ჩვენი სრული, ყოველთვის განახლებული მენიუ — ფასები, კომბოები და დღიური სპეციალები.",
      embedNote:"ნახეთ ჩვენი სრული ინტერაქტიული მენიუ, ყოველთვის განახლებული უახლესი ფასებითა და სპეციალებით.", embedLink:"სრული მენიუ →"
    },
    gallery: { eyebrow:"შიგნიდან", title:"გალერეა", crumb:"გალერეა" },
    contact: {
      eyebrow:"მოხარული ვიქნებით თქვენი მოსმენით", title:"კონტაქტი", crumb:"კონტაქტი",
      formTitle:"მოგვწერეთ", fullName:"სრული სახელი", phone:"ტელეფონი", email:"ელფოსტა", subject:"თემა", message:"შეტყობინება",
      namePh:"თქვენი სახელი", phonePh:"+995 5XX XXX XXX", emailPh:"you@example.com", subjectPh:"როგორ შეგვიძლია დაგეხმაროთ?", messagePh:"გვითხარით რა გაწუხებთ...",
      sendBtn:"შეტყობინების გაგზავნა", formNote:"გაგზავნისას გაიხსნება თქვენი ელფოსტის აპლიკაცია nidsrestaurant@gmail.com-ზე გასაგზავნად.",
      successMsg:"✓ თქვენი შეტყობინება მზად არის — შეამოწმეთ ელფოსტის აპლიკაცია გასაგზავნად.",
      callUs:"დაგვირეკეთ", whatsapp:"WhatsApp", whatsappDesc:"დაგვიკავშირდით მყისიერად", emailUs:"ელფოსტა",
      address:"მისამართი", addressVal:"ბათუმი, აჭარა, საქართველო",
      hours:"მუშაობის საათები", hoursNote:"საათები შეიძლება განსხვავდებოდეს დღესასწაულებზე — წინასწარ დარეკეთ დასადასტურებლად.",
      h1:"ორშაბათი – ხუთშაბათი", h2:"პარასკევი – შაბათი", h3:"კვირა",
      mapEyebrow:"სად ვართ", mapTitle:"რუკაზე"
    },
    reviews: {
      eyebrow:"რას ამბობენ სტუმრები", title:"მიმოხილვები", crumb:"მიმოხილვები",
      reviewSub:"შეფასებული ჩვენი სტუმრების მიერ", reviewGoogle:"ნახეთ ჩვენი Google მიმოხილვები", reviewTrip:"წაიკითხეთ TripAdvisor-ზე", reviewPhotos:"სტუმრების ფოტოები",
      testiEyebrow:"სტუმრების გამოხმაურება", testiTitle:"პირდაპირ სუფრიდან",
      t1q:"\"Beast შაურმა თავის სახელს ამართლებს — უზარმაზარი, ცხელი და გემოთი სავსე. საუკეთესო რულეტი, რაც ბათუმში მიჭამია.\"", t1n:"ნინა კ.", t1r:"ადგილობრივი გიდი",
      t2q:"\"სწრაფი, მეგობრული და ნივრის სოუსი დამოკიდებულია. მოგზაურობის დროს სამჯერ დავბრუნდით.\"", t2n:"ლევან თ.", t2r:"რეგულარული სტუმარი",
      t3q:"\"ოჯახისთვის განკუთვნილი, დიდი პორციები და ყველაფერი ნამდვილად ახალია. Phoenix აუცილებლად უნდა სცადოთ.\"", t3n:"სოფია მ.", t3r:"ტურისტის მიმოხილვა",
      t4q:"\"მშვენიერი ადგილი სწრაფი, დამაკმაყოფილებელი კვებისთვის ბულვართან. Nid'Z Special მარტო ღირს მისვლად.\"", t4n:"დავით პ.", t4r:"Google მიმოხილვა",
      t5q:"\"პორციები უზარმაზარია და ყველაფერი თქვენს თვალწინ მზადდება. შესანიშნავი ფასი ხარისხისთვის.\"", t5n:"ანა გ.", t5r:"Google მიმოხილვა",
      t6q:"\"ბავშვები წავიყვანე და მოეწონათ — არაფორმალური, სწრაფი, პერსონალი ნამდვილად მისასალმებელი იყო.\"", t6n:"მარი ბ.", t6r:"TripAdvisor",
      note:"ნაჩვენებია სტუმრების ციტატები მაგალითისთვის — დააკავშირეთ თქვენი ცოცხალი Google/TripAdvisor არხი ან ნებისმიერ დროს შეცვალეთ რეალური მიმოხილვებით.",
      ctaTitle:"მოგეწონათ ვიზიტი?", ctaDesc:"დაგვიტოვეთ მიმოხილვა Google-ზე ან TripAdvisor-ზე — ჩვენი პატარა გუნდისთვის ეს ბევრს ნიშნავს.",
      ctaGoogle:"მიმოხილვა Google-ზე", ctaTrip:"მიმოხილვა TripAdvisor-ზე"
    },
    order: {
      eyebrow:"გვერდი აუარეთ რიგს", title:"ონლაინ შეკვეთა", crumb:"ონლაინ შეკვეთა",
      pickupTab:"გატანით", deliveryTab:"მიტანით",
      chatEyebrow:"სწრაფი და მარტივი", chatTitle:"გატანით შეკვეთა",
      chatDesc:"მოგვწერეთ WhatsApp-ზე ან დაგვირეკეთ — ჩვენ დავადასტურებთ თქვენს შეკვეთას და ახალს მოვამზადებთ თქვენს მოსვლამდე.",
      whatsappBtn:"💬 WhatsApp-ით შეკვეთა", callBtn:"📞 დარეკვა — +995 571 530 290",
      viewMenuLink:"ჯერ სრული მენიუ ნახეთ →",
      deliveryEyebrow:"მიტანა კარამდე", deliveryTitle:"მიტანის შეკვეთა Wolt-ით",
      deliveryDesc:"ჩვენ ვთანამშრომლობთ Wolt-თან მიტანისთვის — ნახეთ სრული მენიუ, თვალი ადევნეთ კურიერს რეალურ დროში და გადაიხადეთ პირდაპირ მათ აპლიკაციაში ან საიტზე.",
      deliveryBtn:"Wolt-ით შეკვეთა →",
      deliveryNote:"გირჩევნიათ მიტანა თავად მოაწყოთ? მოგვწერეთ WhatsApp-ზე და ჩვენ მაქსიმალურად დაგეხმარებით."
    },
    legal: {
      eyebrow:"იურიდიული",
      privacyTitle:"კონფიდენციალურობის პოლიტიკა", privacyCrumb:"კონფიდენციალურობის პოლიტიკა",
      termsTitle:"მომსახურების პირობები", termsCrumb:"მომსახურების პირობები"
    }
  }
};

const NIDZ_LANGS = ["en", "ar", "ru", "ka"];
