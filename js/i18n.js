...
const I18N = {
  en: {
    ...
    menu: {
      ...
      embedNote:"Menu not loading?", embedLink:"Open it in a new tab →"
    },
    ...
    order: {
      ...
      payEyebrow:"Pay By Card", payTitle:"Choose & Pay",
      payDesc:"Select a dish to pay securely online via Stripe. You'll get a confirmation and we'll start firing up your order for pickup.",
      secured:"🔒 Secured by Stripe", buyNow:"Buy Now",
      chatEyebrow:"Prefer To Chat?", chatTitle:"Order Via WhatsApp",
      chatDesc:"Tell us what you'd like and we'll confirm your order and payment method directly — cash, card on pickup, or a Stripe payment link sent to you.",
      whatsappBtn:"💬 Order On WhatsApp", callBtn:"📞 Call To Order — +995 571 530 290",
      ownerTitle:"For The Restaurant Owner",
      ownerDesc:"\"Buy Now\" buttons open the Stripe Payment Link set in js/config.js. Create a free Payment Link per item (or one general link) in your Stripe Dashboard, paste the URL into stripeDefaultLink or a per-item stripeLink in js/menu-data.js, and card payments start working immediately — no backend required.",
  ...
  ar: {
    ...
    footer: {
      tagline:"شاورما وكباب ولفائف مشوية على النار الحية، تُحضّر طازجة يوميًا في باتومي — مكونات حقيقية، طعم أصيل.",
      taglineShort:"شاورما وكباب ولفائف مشوية على النار الحية، تُحضّر طازجة في باتومي.",
    ...
    home: {
      heroTitle1:"نار طازجة.", heroTitle2:"نكهة حقيقية.",
      heroLede:"شاورما وكباب ولفائف مشوية على النار الحية، تُلَفّ طازجة عند الطلب في قلب باتومي.",
      orderNow:"🔥 اطلب الآن", viewMenu:"عرض القائمة", scroll:"مرر للأسفل",
      ...
      featuredDesc:"طعم ما يخرج من النار كل يوم — طبقة تلو طبقة، دون استعجال.",
      seeFullMenu:"عرض القائمة الكاملة",
      whyEyebrow:"لماذا نيدز", whyTitle:"مبني على النار، لا على الاختصارات",
      ...
      galleryEyebrow:"خلف اللفة", galleryTitle:"لمحة من داخل مطبخنا", viewFullGallery:"عرض المعرض كاملاً",
      testiEyebrow:"يقول ضيوفنا", testiTitle:"مباشرة من الطاولة",
    ...
    menu: {
      ...
      embedNote:"القائمة لا تظهر؟", embedLink:"افتحها في تبويب جديد ←"
    },
    ...
    reviews: {
      ...
      testiEyebrow:"آراء الضيوف", testiTitle:"مباشرة من الطاولة",
      t1q:"«شاورما بيست تستحق اسمها — ضخمة وساخنة ومليئة بالنكهة. أفضل لفة تذوقتها في باتومي.»", t1n:"نينا ك.", t1r:"دليل محلي",
      t2q:"«سريعة وودية، وصلصة الثوم لا تُقاوم. عدنا ثلاث مرات خلال رحلتنا.»", t2n:"ليفان ت.", t2r:"زبون دائم",
      t3q:"«مناسبة للعائلات، وحصص سخية، وكل شيء طازج فعلاً. فينكس لا بد من تجربته.»", t3n:"صوفيا م.", t3r:"تقييم سائحة",
    ...
    order: {
      ...
      payEyebrow:"ادفع بالبطاقة", payTitle:"اختر وادفع",
      payDesc:"اختر طبقًا للدفع بأمان أونلاين عبر Stripe. ستحصل على تأكيد وسنبدأ فورًا بتحضير طلبك للاستلام.",
      secured:"🔒 محمي عبر Stripe", buyNow:"اشترِ الآن",
      chatEyebrow:"تفضل الدردشة؟", chatTitle:"اطلب عبر واتساب",
      chatDesc:"أخبرنا بما ترغب به وسنؤكد طلبك وطريقة الدفع مباشرة — نقدًا، بالبطاقة عند الاستلام، أو رابط دفع Stripe يُرسل إليك.",
      whatsappBtn:"💬 اطلب عبر واتساب", callBtn:"📞 اتصل للطلب — 995 571 530 290+",
      ownerTitle:"ملاحظة لصاحب المطعم",
      ownerDesc:"أزرار «اشترِ الآن» تفتح رابط الدفع Stripe المحدد في js/config.js. أنشئ رابط دفع مجاني لكل صنف (أو رابطًا عامًا واحدًا) من لوحة تحكم Stripe، والصق الرابط في stripeDefaultLink أو في stripeLink الخاص بكل صنف داخل js/menu-data.js، وستبدأ عمليات الدفع بالبطاقة فورًا — دون الحاجة لخادم خلفي.",
  ...
  ru: {
    ...
    menu: {
      ...
      embedNote:"Меню не загружается?", embedLink:"Открыть в новой вкладке →"
    },
    ...
    order: {
      ...
      payEyebrow:"Оплата картой", payTitle:"Выберите и оплатите",
      payDesc:"Выберите блюдо для безопасной онлайн-оплаты через Stripe. Вы получите подтверждение, и мы сразу начнём готовить ваш заказ на самовывоз.",
      secured:"🔒 Защищено Stripe", buyNow:"Купить",
      chatEyebrow:"Удобнее в чате?", chatTitle:"Заказ через WhatsApp",
      chatDesc:"Напишите, что хотите заказать, и мы подтвердим заказ и способ оплаты — наличными, картой при получении или по ссылке Stripe.",
      whatsappBtn:"💬 Заказать через WhatsApp", callBtn:"📞 Заказать по телефону — +995 571 530 290",
      ownerTitle:"Для владельца ресторана",
      ownerDesc:"Кнопки «Купить» открывают платёжную ссылку Stripe, указанную в js/config.js. Создайте бесплатную платёжную ссылку для каждого блюда (или одну общую) в панели Stripe, вставьте её в stripeDefaultLink или в поле stripeLink конкретного блюда в js/menu-data.js — и оплата картой заработает сразу, без необходимости в сервере.",
