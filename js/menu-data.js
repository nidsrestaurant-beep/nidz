...
const MENU_ITEMS = [
  ...
  },
  {
    ...
    desc: {
      en: "Crispy escalope with fries, pickles, cabbage slaw, Picasso, barbecue and garlic sauce.",
      ar: "إسكالوب مقرمش مع بطاطا مقلية ومخلل وسلطة ملفوف وصلصة بيكاسو وصلصة الباربكيو وصلصة الثوم.",
      ru: "Хрустящий эскалоп с картофелем фри, солеными огурцами, капустным салатом, соусом Picasso, барбекю и чесночным соусом."
    }
  },
