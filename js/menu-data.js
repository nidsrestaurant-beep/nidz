...
const MENU_ITEMS = [
  ...
  {
    id: "beef-shawarma", category: "shawarma-rolls", img: "assets/img/beef-shawarma.jpg", price: "GEL 24", // ← updated (was GEL 19)
    name: { en: "Beef Shawarma", ar: "شاورما لحم", ru: "Шаурма из говядины" }
  },
  {
    id: "kabab-sandwich", category: "shawarma-rolls", img: "assets/img/kabab.jpg", price: "GEL 22", // ← updated (was GEL 18)
  ...
  {
    id: "nidz-burger-roll", category: "shawarma-rolls", img: "assets/img/burger-roll.jpg", price: "GEL 22", // ← updated (was GEL 18)
  ...
  },
  {
    ...
    name: { en: "Escalope Schnitzel Roll", ar: "لفة إسكالوب شنيتزل", ru: "Ролл с эскалопом-шницелем" }
  },

  /* ===== PLATES ===== */
  {
    id: "beef-shawarma-plate", category: "plates", img: "assets/img/beef-shawarma-plate.jpg", price: "GEL 28", // ← updated (was GEL 25)
  ...
  {
    id: "kabab-plate", category: "plates", img: "assets/img/kabab-plate.jpg", price: "GEL 26", // ← updated (was GEL 24)
  ...
  {
    id: "combo-beef-shawarma", category: "combos", img: "assets/img/beef-shawarma.jpg", price: "GEL 26", // ← updated (was GEL 23)
  ...
  {
    id: "combo-kabab", category: "combos", img: "assets/img/kabab.jpg", price: "GEL 25", // ← updated (was GEL 22)
  ...
  {
    id: "combo-phoenix", category: "combos", img: "assets/img/phoenix.jpg", price: "GEL 26", // ← updated (was GEL 24)
    name: { en: "Phoenix Combo", ar: "كومبو فينكس", ru: "Комбо: Phoenix" }
  },
  {
    id: "combo-burger-roll", category: "combos", img: "assets/img/burger-roll.jpg", price: "GEL 23",
    name: { en: "Nid's Burger Roll Combo", ar: "كومبو لفة برجر نيدز", ru: "Комбо: Бургер-ролл Nid'Z" }
  },
  {
    id: "combo-falafel-roll", category: "combos", img: "assets/img/falafel-roll.jpg", price: "GEL 18",
    name: { en: "Falafel Roll Combo", ar: "كومبو لفة فلافل", ru: "Комбо: Фалафель-ролл" }
  },
  ...
  },
  {
    ...
    name: { en: "Pepsi", ar: "بيبسي", ru: "Пепси" }
  },
  {
  ...
  },
  {
    ...
    name: { en: "Cold Lemonade", ar: "ليموناضة باردة", ru: "Холодный лимонад" }
  },
  {
    id: "non-alcoholic-beer", category: "cold-drinks", emoji: "🍺", price: "GEL 7",
    name: { en: "Non-Alcoholic Beer", ar: "بيرة خالية من الكحول", ru: "Безалкогольное пиво" }
  }
];
...
const MENU_CATEGORIES = [
  ...
  { id: "combos", label: { en: "Combos", ar: "وجبات كاملة", ru: "Комбо" } },
